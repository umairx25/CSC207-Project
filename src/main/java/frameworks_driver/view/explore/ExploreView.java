...
//        JTextField searchField = new JTextField(ExploreViewModel.INITIAL_SEARCH_MESSAGE);
//        JButton searchButton = new JButton("Search");
//        JButton homeButton = new JButton("Home");
//
//        searchField.setBackground(ColourManager.SEARCH_BAR_GRAY);
...
//
//        // Add a FocusListener to display instructions in the search bar
